<template>
  <b-modal
    ...
    centered
    :hide-footer="true"
    :title="t('Update Avvik / RUH')"
    size="lg"
    class="modal-is-edit-avvik-listing-active"
    id="is-edit-avvik-listing-active"
    @close="$emit('update:is-edit-avvik-listing-active', false)"
    :visible="isEditAvvikListingActive"
    @hide="$emit('update:is-edit-avvik-listing-active', false)"
  >
    <div>
      <validation-observer
        ref="refFormObserver"
...
export default {
  ...
  model: {
    prop: 'isEditAvvikListingActive',
    event: 'update:is-edit-avvik-listing-active',
  },
  props: {
  ...
  setup(props, { emit }) {
    ...
    onMounted(async () => {
      if (props.isEditAvvikListingActive) {
        await getAvvikListing(props.avvikListingId)
    ...
    const onSubmit = async () => {
      await updateAvvikListing(formData.value, props.avvikListingId)

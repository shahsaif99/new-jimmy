...
/* harmony import */ var _composables_customer_auth__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/composables/customer/auth */ "./resources/js/src/composables/customer/auth.js");
...
/* harmony import */ var _composables_customer_toaster__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @/composables/customer/toaster */ "./resources/js/src/composables/customer/toaster.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    var root = _ref.root;
    var toast = Object(_composables_customer_toaster__WEBPACK_IMPORTED_MODULE_13__["default"])();

    var _useAuth = Object(_composables_customer_auth__WEBPACK_IMPORTED_MODULE_8__["default"])(),
        busy = _useAuth.busy,
        login = _useAuth.login,
        responseStatus = _useAuth.responseStatus;

    var loginData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_7__["reactive"])({
      email: '',
      password: ''
    });

    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_10__["default"])(),
    ...
    var onSubmit = /*#__PURE__*/function () {
      var _ref2 = Object(E_Projects_PriorityHome_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/Object(E_Projects_PriorityHome_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().mark(function _callee() {
        var _responseStatus$value, data, token;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                if (responseStatus.value.status === 200) {
                  _responseStatus$value = responseStatus.value.data, data = _responseStatus$value.data, token = _responseStatus$value.token;
                  _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_12__["default"].setCustomerToken(token);
                  _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_12__["default"].setCustomerData(JSON.stringify(data));
                  root.$router.replace({
                    name: 'customer-profile'
                  }).then(function () {
                    toast.success("Welcome ".concat(data.first_name, ",  You have successfully logged in."));
                  });
                }
